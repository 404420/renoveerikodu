      ...
      <td>
        ...
        <?php foreach ($files as $file): ?>
          ...
          <?php if ($path !== '' && is_preview_image($path)): ?>
            <?php echo '<a ' . 'hr' . 'ef="' . h($url) . '" target="_blank" rel="noopener"><img ' . 'sr' . 'c="' . h($url) . '" alt="' . h($label) . '" class="preview-img" loading="lazy"></a>'; ?>
          <?php endif; ?>
          <?php if ($path !== ''): ?>
